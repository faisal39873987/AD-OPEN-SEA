-- AD PLUS Assistant - Database Migration SQL
...
CREATE INDEX idx_user_feedback_service_id ON user_feedback(service_id);
...
CREATE POLICY "User requests can be inserted by anyone" ON user_requests
...
CREATE POLICY "User feedback can be inserted by anyone" ON user_feedback
    FOR INSERT USING (true);
