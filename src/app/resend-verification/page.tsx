    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
          {!sent && "Enter your email address and we'll send you a new verification link"}
        </p>
      </motion.div>
        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 border dark:border-gray-700">
          {sent ? (
            ...
            >
              ...
              <h3 className="mt-3 text-lg font-medium text-gray-900 dark:text-white">Verification email sent</h3>
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                We've sent a verification email to {email}. Please check your email inbox and click the verification link.
              </p>
              <div className="mt-6">
                <Link
                  href="/login"
