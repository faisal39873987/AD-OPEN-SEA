...
export default function Navigation() {
  ...
  // Simulated authentication state (replace with actual auth state)
  const [isLoggedIn, setIsLoggedIn] = useState(false)
  
  // Function to toggle login state for testing
  const toggleLogin = () => {
          ...
          <div className="flex items-center">
            ...
            <div className="relative profile-button">
              <button
                ...
                aria-haspopup="true"
                aria-label={`${isLoggedIn ? 'My Account' : 'Sign In'} menu`}
                ...
                >
                  {profileMenu.map((item) => (
                    <Link
                      ...
                      onClick={() => {
                        setProfileMenuOpen(false)
                        if (item.name === 'Sign Out') toggleLogin()
                      }}
                    >
